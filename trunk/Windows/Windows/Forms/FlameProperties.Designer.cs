namespace Xyrus.Apophysis.Windows.Forms
{
	partial class FlameProperties
	{
		...
		private void InitializeComponent()
		{
			...
			this.PaletteEditModeButton = new System.Windows.Forms.Button();
			this.mHandlerSelectMenu = new System.Windows.Forms.ContextMenuStrip(this.components);
			this.RotateHandlerMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.toolStripMenuItem5 = new System.Windows.Forms.ToolStripSeparator();
			this.HueHandlerMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.SaturationHandlerMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.BrightnessHandlerMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.ContrastHandlerMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.toolStripMenuItem6 = new System.Windows.Forms.ToolStripSeparator();
			this.BlurHandlerMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.FrequencyHandlerMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.mHandlerSelectMenu.SuspendLayout();
			this.SuspendLayout();
			// 
			// mPreviewContextMenu
			// 
			...
			resources.ApplyResources(this.CameraTab, "CameraTab");
			this.CameraTab.Name = "CameraTab";
			// 
			// RotationScrollBar
			// 
			resources.ApplyResources(this.RotationScrollBar, "RotationScrollBar");
			...
			// XPositionScrollBar
			// 
			resources.ApplyResources(this.XPositionScrollBar, "XPositionScrollBar");
			...
			resources.ApplyResources(this.ImagingTab, "ImagingTab");
			...
			// 
			resources.ApplyResources(this.GammaThresholdTextBox, "GammaThresholdTextBox");
			...
			resources.ApplyResources(this.mBackgroundLabel, "mBackgroundLabel");
			this.mBackgroundLabel.Name = "mBackgroundLabel";
			// 
			// VibrancyScrollBar
			// 
			resources.ApplyResources(this.VibrancyScrollBar, "VibrancyScrollBar");
			...
			// VibrancyTextBox
			// 
			resources.ApplyResources(this.VibrancyTextBox, "VibrancyTextBox");
			this.VibrancyTextBox.Name = "VibrancyTextBox";
			// 
			// BrightnessScrollBar
			// 
			resources.ApplyResources(this.BrightnessScrollBar, "BrightnessScrollBar");
			...
			// BrightnessTextBox
			// 
			resources.ApplyResources(this.BrightnessTextBox, "BrightnessTextBox");
			this.BrightnessTextBox.Name = "BrightnessTextBox";
			// 
			// GammaScrollBar
			// 
			resources.ApplyResources(this.GammaScrollBar, "GammaScrollBar");
			...
			this.PaletteTab.Controls.Add(this.PaletteEditModeButton);
			...
			// PaletteResetButton
			// 
			resources.ApplyResources(this.PaletteResetButton, "PaletteResetButton");
			...
			// 
			resources.ApplyResources(this.PaletteFromImageButton, "PaletteFromImageButton");
			...
			// 
			resources.ApplyResources(this.PaletteBrowserButton, "PaletteBrowserButton");
			...
			// PastePaletteButton
			// 
			resources.ApplyResources(this.PastePaletteButton, "PastePaletteButton");
			...
			// CopyPaletteButton
			// 
			resources.ApplyResources(this.CopyPaletteButton, "CopyPaletteButton");
			...
			// PaletteEditTextBox
			// 
			resources.ApplyResources(this.PaletteEditTextBox, "PaletteEditTextBox");
			...
			// 
			resources.ApplyResources(this.PaletteEditScrollBar, "PaletteEditScrollBar");
			this.PaletteEditScrollBar.LargeChange = 1;
			this.PaletteEditScrollBar.Name = "PaletteEditScrollBar";
			// 
			// RandomPresetButton
			// 
			resources.ApplyResources(this.RandomPresetButton, "RandomPresetButton");
			...
			resources.ApplyResources(this.mPaletteContextMenu, "mPaletteContextMenu");
			// 
			// RandomizePaletteMenuItem
			// 
			this.RandomizePaletteMenuItem.Name = "RandomizePaletteMenuItem";
			resources.ApplyResources(this.RandomizePaletteMenuItem, "RandomizePaletteMenuItem");
			// 
			// toolStripMenuItem1
			// 
			...
			resources.ApplyResources(this.InvertPaletteMenuItem, "InvertPaletteMenuItem");
			// 
			// ReversePaletteMenuItem
			// 
			this.ReversePaletteMenuItem.Name = "ReversePaletteMenuItem";
			resources.ApplyResources(this.ReversePaletteMenuItem, "ReversePaletteMenuItem");
			// 
			// toolStripMenuItem2
			// 
			...
			// 
			resources.ApplyResources(this.PaletteFromImageMenuItem, "PaletteFromImageMenuItem");
			this.PaletteFromImageMenuItem.Name = "PaletteFromImageMenuItem";
			// 
			// PaletteBrowserMenuItem
			// 
			resources.ApplyResources(this.PaletteBrowserMenuItem, "PaletteBrowserMenuItem");
			...
			// SavePaletteMenuItem
			// 
			resources.ApplyResources(this.SavePaletteMenuItem, "SavePaletteMenuItem");
			...
			// CopyPaletteMenuItem
			// 
			resources.ApplyResources(this.CopyPaletteMenuItem, "CopyPaletteMenuItem");
			this.CopyPaletteMenuItem.Name = "CopyPaletteMenuItem";
			// 
			// PastePaletteMenuItem
			// 
			resources.ApplyResources(this.PastePaletteMenuItem, "PastePaletteMenuItem");
			...
			resources.ApplyResources(this.CanvasTab, "CanvasTab");
			this.CanvasTab.Name = "CanvasTab";
			// 
			// mResizeGroupBox
			// 
			resources.ApplyResources(this.mResizeGroupBox, "mResizeGroupBox");
			...
			// 
			resources.ApplyResources(this.ResizeMainWindowCheckBox, "ResizeMainWindowCheckBox");
			...
			// DepthBlurTextBox
			// 
			resources.ApplyResources(this.DepthBlurTextBox, "DepthBlurTextBox");
			...
			// PitchTextBox
			// 
			resources.ApplyResources(this.PitchTextBox, "PitchTextBox");
			this.PitchTextBox.Name = "PitchTextBox";
			// 
			// YawTextBox
			// 
			resources.ApplyResources(this.YawTextBox, "YawTextBox");
			...
			// PerspectiveTextBox
			// 
			resources.ApplyResources(this.PerspectiveTextBox, "PerspectiveTextBox");
			...
			resources.ApplyResources(this.ScaleDragPanel, "ScaleDragPanel");
			...
			resources.ApplyResources(this.PerspectiveDragPanel, "PerspectiveDragPanel");
			...
			resources.ApplyResources(this.HeightDragPanel, "HeightDragPanel");
			...
			resources.ApplyResources(this.YawDragPanel, "YawDragPanel");
			...
			resources.ApplyResources(this.PitchDragPanel, "PitchDragPanel");
			...
			resources.ApplyResources(this.DepthBlurDragPanel, "DepthBlurDragPanel");
			...
			// 
			// PaletteEditModeButton
			// 
			resources.ApplyResources(this.PaletteEditModeButton, "PaletteEditModeButton");
			this.PaletteEditModeButton.Name = "PaletteEditModeButton";
			this.PaletteEditModeButton.UseVisualStyleBackColor = true;
			this.PaletteEditModeButton.Click += new System.EventHandler(this.OnSelectPaletteEditHandlerClick);
			// 
			// mHandlerSelectMenu
			// 
			this.mHandlerSelectMenu.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.RotateHandlerMenuItem,
            this.toolStripMenuItem5,
            this.HueHandlerMenuItem,
            this.SaturationHandlerMenuItem,
            this.BrightnessHandlerMenuItem,
            this.ContrastHandlerMenuItem,
            this.toolStripMenuItem6,
            this.BlurHandlerMenuItem,
            this.FrequencyHandlerMenuItem});
			this.mHandlerSelectMenu.Name = "mHandlerSelectMenu";
			resources.ApplyResources(this.mHandlerSelectMenu, "mHandlerSelectMenu");
			// 
			// RotateHandlerMenuItem
			// 
			this.RotateHandlerMenuItem.Name = "RotateHandlerMenuItem";
			resources.ApplyResources(this.RotateHandlerMenuItem, "RotateHandlerMenuItem");
			// 
			// toolStripMenuItem5
			// 
			...
			// HueHandlerMenuItem
			// 
			this.HueHandlerMenuItem.Name = "HueHandlerMenuItem";
			resources.ApplyResources(this.HueHandlerMenuItem, "HueHandlerMenuItem");
			// 
			// SaturationHandlerMenuItem
			// 
			this.SaturationHandlerMenuItem.Name = "SaturationHandlerMenuItem";
			resources.ApplyResources(this.SaturationHandlerMenuItem, "SaturationHandlerMenuItem");
			// 
			// BrightnessHandlerMenuItem
			// 
			this.BrightnessHandlerMenuItem.Name = "BrightnessHandlerMenuItem";
			resources.ApplyResources(this.BrightnessHandlerMenuItem, "BrightnessHandlerMenuItem");
			// 
			// ContrastHandlerMenuItem
			// 
			this.ContrastHandlerMenuItem.Name = "ContrastHandlerMenuItem";
			resources.ApplyResources(this.ContrastHandlerMenuItem, "ContrastHandlerMenuItem");
			// 
			// toolStripMenuItem6
			// 
			...
			// BlurHandlerMenuItem
			// 
			this.BlurHandlerMenuItem.Name = "BlurHandlerMenuItem";
			resources.ApplyResources(this.BlurHandlerMenuItem, "BlurHandlerMenuItem");
			// 
			// FrequencyHandlerMenuItem
			// 
			this.FrequencyHandlerMenuItem.Name = "FrequencyHandlerMenuItem";
			resources.ApplyResources(this.FrequencyHandlerMenuItem, "FrequencyHandlerMenuItem");
			// 
			// FlameProperties
			// 
			...
			this.mHandlerSelectMenu.ResumeLayout(false);
		...
		public System.Windows.Forms.Button PaletteEditModeButton;
		private System.Windows.Forms.ContextMenuStrip mHandlerSelectMenu;
		private System.Windows.Forms.ToolStripSeparator toolStripMenuItem5;
		private System.Windows.Forms.ToolStripSeparator toolStripMenuItem6;
		public System.Windows.Forms.ToolStripMenuItem RotateHandlerMenuItem;
		public System.Windows.Forms.ToolStripMenuItem HueHandlerMenuItem;
		public System.Windows.Forms.ToolStripMenuItem SaturationHandlerMenuItem;
		public System.Windows.Forms.ToolStripMenuItem BrightnessHandlerMenuItem;
		public System.Windows.Forms.ToolStripMenuItem ContrastHandlerMenuItem;
		public System.Windows.Forms.ToolStripMenuItem BlurHandlerMenuItem;
		public System.Windows.Forms.ToolStripMenuItem FrequencyHandlerMenuItem;
	}
}