...
type
  TVariationPostFalloff2 = class(TVariation)
  const
...
procedure TVariationPostFalloff2.ObtainCalculateFunctionPtr(out f: TCalcFunction);
begin
...
///////////////////////////////////////////////////////////////////////////////
class function TVariationPostFalloff2.GetInstance: TVariation;
begin
...
///////////////////////////////////////////////////////////////////////////////
initialization RegisterVariation(TIntegratedVariationLoader.Create(TVariationPostFalloff2, true, true)) end.
