object AdjustForm: TAdjustForm
  ...
  object gradientGroup: TGroupBox
    Left = 383
    Top = 8
    Width = 363
    Height = 140
  ...
  object cameraGroup: TGroupBox
    ...
    object txtZoom: TEdit
      ...
      TabOrder = 4
      Text = '0'
      OnEnter = HandleEditBoxEnter
      OnExit = UpdateZoomFromTextBox
      OnKeyPress = HandleEditBoxKeyPress
    end
    object txtCenterX: TEdit
      ...
      Text = '0'
      OnEnter = HandleEditBoxEnter
      OnExit = UpdateCenterXFromTextBox
      OnKeyPress = HandleEditBoxKeyPress
    end
    object txtCenterY: TEdit
      ...
      Text = '0'
      OnEnter = HandleEditBoxEnter
      OnExit = UpdateCenterYFromTextBox
      OnKeyPress = HandleEditBoxKeyPress
    end
  ...
  object renderingGroup: TGroupBox
    Left = 185
    Top = 31
    Width = 185
    Height = 159
    ...
    object txtGammaThreshold: TEdit
      ...
      Text = '0'
      OnEnter = HandleEditBoxEnter
      OnExit = UpdateGammaThresholdFromTextBox
      OnKeyPress = HandleEditBoxKeyPress
    end
    object txtVibrancy: TEdit
      ...
      Text = '0'
      OnEnter = HandleEditBoxEnter
      OnExit = UpdateVibrancyFromTextBox
      OnKeyPress = HandleEditBoxKeyPress
    end
    object txtBrightness: TEdit
      ...
      Text = '0'
      OnEnter = HandleEditBoxEnter
      OnExit = UpdateBrightnessFromTextBox
      OnKeyPress = HandleEditBoxKeyPress
    end
  ...
  object imageSizeGroup: TGroupBox
    Left = 8
    Top = 376
    Width = 362
    Height = 146
